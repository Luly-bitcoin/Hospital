...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-02-2026 a las 21:54:53
...
(4, 'U01-C1', 3, 'libre', 'N', 'Cama urgencias');
...
(1, 1, 'HTA controlada', 'Ninguna', 'Enalapril', 'Control posoperatorio', 36.7, 78, 18, '120/80', '2025-11-26 16:05:18', 2),
...
(1, 1, 'Apendicitis aguda', 'ANALISIS: Hemograma, Rx abdomen', 'Cirugía laparoscópica, analgesia', 'Evoluciona favorable', '2025-11-26 16:05:18', 3);
...
(30123456, 'Juan', 'Perez', '', '1980-05-12', '2611234567', '2664009876', 'Elsa Castro', 'Calle Falsa 123', 'San Luis', 45, '2025-11-26 16:05:18', 0),
...
(2, 11223344, 10, '2025-11-29 17:00:00', NULL, 'pendiente', 'dolor de pecho', NULL, 1, '2025-11-27 14:35:26');
...
(1, 'admin', 'TO_REPLACE_HASH_ADMIN', 'Administrador', 'admin@example.com', 1, 1, '2025-11-26 16:05:18'),
(2, 'enf1', 'TO_REPLACE_HASH_ENF', 'Enfermeria 1', 'enf1@example.com', 2, 1, '2025-11-26 16:05:18'),
(3, 'med1', 'TO_REPLACE_HASH_MED', 'Medico 1', 'med1@example.com', 3, 1, '2025-11-26 16:05:18');
...
--
ALTER TABLE `admisiones`
  MODIFY `id_admision` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `evaluacion_enfermeria`
  MODIFY `id_eval_enf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `evaluacion_medica`
--
ALTER TABLE `evaluacion_medica`
  MODIFY `id_eval_med` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
